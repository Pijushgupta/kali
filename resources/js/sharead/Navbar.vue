...
if (localStorage.getItem('color-theme') === 'dark' || 
   (!localStorage.getItem('color-theme') && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
    document.documentElement.classList.add('dark'); // Set dark theme
    themeToggleLightIcon.classList.remove('hidden'); // Show light icon
    themeToggleDarkIcon.classList.add('hidden'); // Hide dark icon
} else {
    document.documentElement.classList.remove('dark'); // Set light theme
    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Kali Cms</span>
          </Link>
        </div>
